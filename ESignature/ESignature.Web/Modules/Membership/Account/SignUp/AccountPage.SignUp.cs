...
namespace ESignature.Membership.Pages
{
        ...
        public Result<ServiceResponse> SignUp(SignUpRequest request)
        {
            return this.UseConnection("Default", connection =>
            {
                ...
                using (var uow = new UnitOfWork(connection))
                {
                    ...
                    ESignature.DAL.Email.SendMail("yogesh.j@smartisystems.com", email, emailBody, "Welcome to E- Signature - Sign Up Your Account");
