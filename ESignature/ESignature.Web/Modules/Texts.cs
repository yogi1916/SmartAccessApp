    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your ESignature Password";
                ...
                {
                    public static LocalText FormTitle = "Welcome to Access Control";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your ESignature Account";
                    ...
                    public static LocalText FormTitle = "Sign up for ESignature";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "Access Control";
        }
        ...
        public static class Site
        {
            ...
            public static class Layout
            {
                ...
                public static LocalText FooterInfo = "Version: V 1.0.0 Logged in Time : "+ DateTime.Now.ToString("HH:mm:ss") ;
                public static LocalText FooterRights = "All rights reserved to Smart I Electronics Systems.";
